...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(1282, 654);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        verticalLayoutWidget = new QWidget(centralWidget);
        verticalLayoutWidget->setObjectName(QString::fromUtf8("verticalLayoutWidget"));
        verticalLayoutWidget->setGeometry(QRect(130, 20, 971, 80));
        ...
        searchTextEdit = new QTextEdit(verticalLayoutWidget);
        searchTextEdit->setObjectName(QString::fromUtf8("searchTextEdit"));
        QFont font;
        font.setPointSize(25);
        searchTextEdit->setFont(font);
